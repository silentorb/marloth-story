...
- TypeScript domain scripts live under `./scripts/`; Tome packages (`tome-db`, `tome-store-flatfile`, `tome-cache-sqlite`, `tome-editor`, `tome-static-site`) live in the sibling **`tome`** repository. In silentorb-workbench, open the devcontainer and use the **`tome` Compose service** for `editor:dev` (not this repo directly).
...
| Task                                 | Do                                                                                                                            | Do not                                           |
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| Add or edit nodes, bodies, titles    | Edit `content/data/{shard}/{nodeId}.md` or use the Tome editor / `ContentStore` (`tome-store-flatfile` / `tome-db` in sibling **tome** repo)                            | Edit `data/tome.sqlite` (or legacy `data/marloth.sqlite`) directly              |
