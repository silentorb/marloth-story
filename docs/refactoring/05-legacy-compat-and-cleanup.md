...
2. **[`docs/features/tome-db.md`](../features/tome-db.md)** — full model file list including `workspace.json`, `table-presentation.json`; legacy compat subsection
3. **[`docs/features/table-presentation.md`](../features/table-presentation.md)** — JSON config location (if session 03 done)
