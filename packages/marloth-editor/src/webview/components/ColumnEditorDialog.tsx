...
export function ColumnEditorDialog({
  ...
  return (
    <>
      ...
      >
        <div
          className="marloth-add-relationship-dialog marloth-column-editor-dialog"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <form className="marloth-column-editor-form" onSubmit={handleSubmit}>
            <label className="marloth-column-editor-field">
              <span>Name</span>
              <input
                value={form.name}
                disabled={busy}
              ...
              />
              <span className="marloth-column-editor-hint">Display label in the table header.</span>
            </label>
            ...
            <label className="marloth-column-editor-field">
              ...
              {state.mode === "edit" && effectiveKey !== initialForm.key ? (
                <span className="marloth-column-editor-hint is-warning">
                  Renaming the key migrates stored values on every row.
                </span>
              ) : (
                <span className="marloth-column-editor-hint">
            ...
            {error ? <p className="marloth-add-relationship-error">{error}</p> : null}

            <div className="marloth-column-editor-actions">
