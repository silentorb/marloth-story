...
export function TableLinkExistingRowTrigger({ label = "Link" }: TableLinkExistingRowTriggerProps) {
  ...
  return (
    <button
      type="button"
      className="marloth-table-link-existing-btn"
      onClick={expand}
    >
      {label}
    </button>
...
export function TableLinkExistingRowFooter() {
  ...
  if (!expanded) {
    return (
      <div className="marloth-table-link-existing">
        <button
          type="button"
          className="marloth-table-link-existing-trigger"
          onClick={expand}
        >
          + {footerLabel}
        </button>
  ...
  return (
    <div className="marloth-table-link-existing marloth-table-link-existing-form">
      <RecordLinkPicker
        api={api}
        embedded
        closeOnSelect={false}
        ...
        onClose={reset}
      />
      <button type="button" className="marloth-btn-secondary" onClick={reset}>
        Cancel
      </button>
    </div>
  );
