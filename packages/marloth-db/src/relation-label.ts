/**
 * Maps Notion database property names to graph relationship labels for relation columns.
...
/** Graph relationship label for a Notion relation property (e.g. "Bible passages" → "BIBLE_PASSAGES"). */
